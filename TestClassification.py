...
classifier.add(Conv2D(32, (3, 3), padding="same", input_shape=(64, 64, 3), activation="softmax"))
...
classifier.add(Conv2D(32, (3, 3), padding="same", activation = 'softmax'))
classifier.add(MaxPooling2D(pool_size = (2, 2)))

#adding 2 more layer of convolution layers
classifier.add(Conv2D(64, (3, 3), padding="same", activation = 'softmax'))
classifier.add(MaxPooling2D(pool_size = (2, 2)))
...
classifier.save_weights("cat_dog_model.h5")
